...
async function loginWithSpotify() {
   try {
       const spotifyAuthUrl = 'http://10.0.2.15:5000/login'; //replace with your port number like mine, dont use locahost link, swetha's
       //const spotifyAuthUrl =     //saniya's
       //const spotifyAuthUrl =     //maggie's
