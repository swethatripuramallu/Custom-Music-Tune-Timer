...
def parse_songs(happy, sad, dance, productive):
    if 'recommended-songs' not in session:
        songs = get_recommendations(happy, sad, dance, productive)
        print("SONGS",songs)
        session['recommended-songs'] = songs
    ...
    print("TRACKS",tracks_get_recommendations)
...
if __name__ == '__main__':
    app.run(port = "3002", debug=True) #any changes we make in the code the 
