...
def index():
    ...
    # planning on making this separate where it includes
    # a react front end page for this
...
def login():
    ...
    params = {
        ...
        # to make debugging easier for local server purpose, can change
        # at the end
    }
...
def get_playlists():
    ...
    if datetime.now().timestamp() > session['expires_at']:
        return redirect('/refresh-token')  # automatically refresh it for them
    # so we don't interrupt the user interface
